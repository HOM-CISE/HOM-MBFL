...
def createResOriginalFaultVersionInShellFileMode():
    f_create_shell = open("./create_RQ1_res_original_fault_version_in.sh", "w")
    for mutant_set_index in range(1, args.num_mutants_set + 1):
        mutation_list = []
        with open(args.RQ1_mutant_path + "mutant_set_" + str(mutant_set_index) + "/res_execute_mutant.txt", "r") as f:
        ...
        file_name = ""
        compile_dir = args.RQ1_mutant_path + "mutant_set_" + str(mutant_set_index) + "/compile/"
        ...
        f_create_shell.write("rm " + args.RQ1_mutant_path + "mutant_set_" + str(mutant_set_index) + "/res_original_version.in " + args.RQ1_mutant_path + "mutant_set_" + str(mutant_set_index) + "/res_fault_version.in\n")
        f_create_shell.write("touch " + args.RQ1_mutant_path + "mutant_set_" + str(mutant_set_index) + "/res_original_version.in " + args.RQ1_mutant_path + "mutant_set_" + str(mutant_set_index) + "/res_fault_version.in\n")
        ...
        for excute_mutation in mutation_list:
            ...
            for input_sample in input_list:
                ...
                f_create_shell.write('fi\n')
                f_create_shell.write('\n')
            f_create_shell.write("python3 ideal_higher_mutant_set_extend/append_res_original_version_in.py --true_root_dir " + args.true_root_dir + "--RQ1_mutant_path ./_RQ1_mutant_set/ --num_mutants_set " + str(mutant_set_index) + "\n")
            f_create_shell.write("python3 ideal_higher_mutant_set_extend/append_res_fault_version_in.py --defect_root_dir " + args.defect_root_dir + "--RQ1_mutant_path ./_RQ1_mutant_set/ --num_mutants_set " + str(mutant_set_index) + "\n")
