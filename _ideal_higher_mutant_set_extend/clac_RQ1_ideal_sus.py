...
def CreateAllMutantSuspicious():
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/all_execute_mutant.txt", 'r') as f:
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/res_fault_version.in", "r") as f:
    ...
    for str_fault_version_line in list_fault_version:
        ...
        list_sus_Dstar3.append("Dstar3_Sus: " + str(Dstar3(Akf, Akp, Anf)) + "   "
                               ...
                               + list_all_execute_mutant[line_index])
        line_index += 1
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Jaccard.txt", 'w') as f:
        str_sus_Jaccard = "\n".join(list_sus_Jaccard)
        f.write(str_sus_Jaccard)
    f.close()
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Ochiai.txt", 'w') as f:
        str_sus_Ochiai = "\n".join(list_sus_Ochiai)
        f.write(str_sus_Ochiai)
    f.close()
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Op2.txt", 'w') as f:
        str_sus_Op2 = "\n".join(list_sus_Op2)
        f.write(str_sus_Op2)
    f.close()
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Tarantula.txt", 'w') as f:
        str_sus_Tarantula = "\n".join(list_sus_Tarantula)
        f.write(str_sus_Tarantula)
    f.close()
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Dstar3.txt", 'w') as f:
...
if __name__ == "__main__":
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Jaccard.txt", 'r') as f:
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Ochiai.txt", 'r') as f:
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Op2.txt", 'r') as f:
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Tarantula.txt", 'r') as f:
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_Dstar3.txt", 'r') as f:
    ...
    with open("./_RQ1_mutant_set/mutant_set_ideal/suspicious_set.txt", 'w') as f:
        f.write("")
