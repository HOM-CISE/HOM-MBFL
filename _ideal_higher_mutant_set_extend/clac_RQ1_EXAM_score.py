...
def calcRank(list_fault_line, suspicious_file_root):
    suspicious_file_path = suspicious_file_root + "suspicious_combine.txt"
    ...
    with open(suspicious_file_root + "suspicious_rank.txt", 'w') as f:
...
def calcEXAMScore(list_fault_line, suspicious_file_root):
    ...
    f = open(suspicious_file_root + "suspicious_EXAM_score.txt", 'w')
    ...
    for num_fault_line in range(1, args.num_mutants_set+1):
    ...
    f.write("Jaccard_EXAM: " + str(sum_Jaccard_EXAM / args.num_mutants_set) + '\n')
    f.write("Ochiai_EXAM: " + str(sum_Ochiai_EXAM / args.num_mutants_set) + '\n')
    f.write("Op2_EXAM: " + str(sum_Op2_EXAM / args.num_mutants_set) + '\n')
    f.write("Tarantula_EXAM: " + str(sum_Tarantula_EXAM / args.num_mutants_set) + '\n')
    f.write("Dstar3_EXAM: " + str(sum_Dstar3_EXAM / args.num_mutants_set) + '\n')
    f.close()
...
if __name__ == "__main__":
    ...
    for mutant_set_index in range(1, num_mutants_set+1):
        str_mutant_suspicious_file_root = args.RQ1_mutant_path + "mutant_set_" + str(mutant_set_index) + "/"

        calcEXAMScore(list_fault_line, str_mutant_suspicious_file_root)
