...
def parserCommad():
    ...
    parser.add_argument('--RQ1_mutant_path', action='store',
                        ...
                        help='Path of storing RQ1 mutants.')
...
if __name__ == "__main__":
    ...
    RQ1_mutant_path = args.RQ1_mutant_path
    # print(defect_source_name)
    # print(defect_source_path)
    # print(type(num_mutants_set))
    # print(RQ1_mutant_path)

    for RQ1_mutant_set_index in range(1, num_mutants_set+1):
        str_mutant_source_path = RQ1_mutant_path + "mutant_set_" + str(RQ1_mutant_set_index) + "/Mutant_source/"
        if not os.path.exists(str_mutant_source_path):
            os.mkdir(str_mutant_source_path)

        Mutation(RQ1_mutant_path+"mutant_set_"+str(RQ1_mutant_set_index)+"/res_record.txt", defect_source_name,
