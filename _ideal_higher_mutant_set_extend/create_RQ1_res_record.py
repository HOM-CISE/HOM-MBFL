...
def createRQ1ResRecord(list_res_mutant_line, dict_mutant_information):
...
if __name__ == "__main__":
    ...
    # 2.read the file of "./output/Fault_Record.txt", record all of the fault lines.
    ...
    # 3.read all mutant sets' "res_mutant_line.txt" to generate "res_record.txt".
    for mutant_set_index in range(1, mutant_set_num+1):
        with open("./_RQ1_mutant_set/mutant_set_" + str(mutant_set_index) + "/res_mutant_line.txt", 'r') as f:
            list_res_mutant_line = f.read().split('\n')[:-1]
        f.close()
        # print(list_res_mutant_line)
        createRQ1ResRecord(list_res_mutant_line, dict_mutant_information)
        with open("./_RQ1_mutant_set/mutant_set_" + str(mutant_set_index) + "/res_record.txt", 'w') as f:
