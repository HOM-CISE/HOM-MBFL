...
if __name__ == "__main__":
    ...
    path_suspicious_set = "./_RQ1_mutant_set/mutant_set_ideal/suspicious_set.txt"
    path_suspicious_combine = "./_RQ1_mutant_set/mutant_set_ideal/suspicious_combine.txt"
