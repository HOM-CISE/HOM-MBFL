...
if __name__ == "__main__":
    args = parserCommad()
    # print(args.RQ1_mutant_path)
    # print(args.num_mutants_set)
    ...
    for mutants_set_index in range(1, args.num_mutants_set+1):
        path_suspicious_set = args.RQ1_mutant_path + "mutant_set_" + str(mutants_set_index) + "/suspicious_set.txt"
        path_suspicious_combine = args.RQ1_mutant_path + "mutant_set_" + str(mutants_set_index) + "/suspicious_combine.txt"
