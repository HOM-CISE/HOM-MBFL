    ...
    for mutant_set_index in range(1, args.num_mutants_set + 1):
        ...
        for excute_mutation in mutation_list:
            ...
            for input_sample in input_list:
                ...
                f_create_shell.write('fi\n')
                f_create_shell.write('\n')
            f_create_shell.write("python ideal_higher_mutant_set_extend/append_RQ1_ideal_res_original_version_in.py --true_root_dir " + args.true_root_dir + "\n")
            f_create_shell.write("python ideal_higher_mutant_set_extend/append_RQ1_ideal_res_fault_version_in.py --defect_root_dir " + args.defect_root_dir + "\n")
...
def createResOriginalFaultVersionInShellArgsMode():
    f_create_shell = open("./create_RQ1_ideal_res_original_fault_version_in.sh", "w")
    mutation_list = []
    with open("./_RQ1_mutant_set/mutant_set_ideal/res_execute_mutant.txt", "r") as f:
        mutation_list = f.read()
        mutation_list = mutation_list.split("\n")[:-1]
    f.close()
