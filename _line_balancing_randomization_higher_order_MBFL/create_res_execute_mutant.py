...
if __name__ == "__main__":
    ...
    with open("./_line_balancing_randomization_higher_order_mutant_set/res_execute_mutant.txt", 'w') as f:
        f.write("")   # create and clean res_record.txt
        f.close()
    f = open("./_line_balancing_randomization_higher_order_mutant_set/res_execute_mutant.txt", 'a')
