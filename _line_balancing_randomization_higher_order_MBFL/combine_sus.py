...
if __name__ == "__main__":
    ...
    path_suspicious_set = "./_line_balancing_randomization_higher_order_mutant_set/suspicious_set.txt"
    path_suspicious_combine = "./_line_balancing_randomization_higher_order_mutant_set/suspicious_combine.txt"
