...
if __name__ == "__main__":
    ...
    with open("./_MBFL_randomization_higher_order_mutant_set/res_mutant_line.txt", 'r') as f:
        list_res_mutant_line = f.read().split('\n')
    f.close()
    # print(list_res_mutant_line)
    createResRecord(list_res_mutant_line, dict_mutant_information)
    with open("./_MBFL_randomization_higher_order_mutant_set/res_record.txt", 'w') as f:
