...
def CreateAllMutantSuspicious():
    ...
    with open("./_MBFL_randomization_higher_order_mutant_set/all_execute_mutant.txt", 'r') as f:
    ...
    with open("./_MBFL_randomization_higher_order_mutant_set/res_fault_version.in", "r") as f_fault:
    ...
    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Jaccard.txt", 'w') as f:
        str_sus_Jaccard = "\n".join(list_sus_Jaccard)
        f.write(str_sus_Jaccard)
    f.close()
    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Ochiai.txt", 'w') as f:
        str_sus_Ochiai = "\n".join(list_sus_Ochiai)
        f.write(str_sus_Ochiai)
    f.close()
    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Op2.txt", 'w') as f:
        str_sus_Op2 = "\n".join(list_sus_Op2)
        f.write(str_sus_Op2)
    f.close()
    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Tarantula.txt", 'w') as f:
        str_sus_Tarantula = "\n".join(list_sus_Tarantula)
        f.write(str_sus_Tarantula)
    f.close()
    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Dstar3.txt", 'w') as f:
...
if __name__ == "__main__":
    ...
    dict_sus_Jaccard = {}
    dict_sus_Jaccard_mutate_num_each_line = {}

    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Jaccard.txt", 'r') as f:
    ...
    for sus_Jaccard_line in list_sus_Jaccard:
        ...
        for source_line in list_source_line:
            if dict_sus_Jaccard.get(source_line) == None:
                ...
                dict_sus_Jaccard_mutate_num_each_line[source_line] = 1
            else:
                mutate_num = dict_sus_Jaccard_mutate_num_each_line[source_line]
                dict_sus_Jaccard[source_line] = (dict_sus_Jaccard[source_line] * mutate_num + suspicious_now) / (mutate_num + 1)
                dict_sus_Jaccard_mutate_num_each_line[source_line] += 1
    ...
    dict_sus_Ochiai = {}
    dict_sus_Ochiai_mutate_num_each_line = {}

    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Ochiai.txt", 'r') as f:
    ...
    for sus_Ochiai_line in list_sus_Ochiai:
        ...
        for source_line in list_source_line:
            if dict_sus_Ochiai.get(source_line) == None:
                ...
                dict_sus_Ochiai_mutate_num_each_line[source_line] = 1
            else:
                mutate_num = dict_sus_Ochiai_mutate_num_each_line[source_line]
                dict_sus_Ochiai[source_line] = (dict_sus_Ochiai[source_line] * mutate_num + suspicious_now) / (mutate_num + 1)
                dict_sus_Ochiai_mutate_num_each_line[source_line] += 1
    ...
    dict_sus_Op2 = {}
    dict_sus_Op2_mutate_num_each_line = {}

    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Op2.txt", 'r') as f:
    ...
    for sus_Op2_line in list_sus_Op2:
        ...
        for source_line in list_source_line:
            if dict_sus_Op2.get(source_line) == None:
                ...
                dict_sus_Op2_mutate_num_each_line[source_line] = 1
            else:
                mutate_num = dict_sus_Op2_mutate_num_each_line[source_line]
                dict_sus_Op2[source_line] = (dict_sus_Op2[source_line] * mutate_num + suspicious_now) / (mutate_num + 1)
                dict_sus_Op2_mutate_num_each_line[source_line] += 1
    ...
    dict_sus_Tarantula = {}
    dict_sus_Tarantula_mutate_num_each_line = {}

    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Tarantula.txt", 'r') as f:
    ...
    for sus_Tarantula_line in list_sus_Tarantula:
        ...
        for source_line in list_source_line:
            if dict_sus_Tarantula.get(source_line) == None:
                ...
                dict_sus_Tarantula_mutate_num_each_line[source_line] = 1
            else:
                mutate_num = dict_sus_Tarantula_mutate_num_each_line[source_line]
                dict_sus_Tarantula[source_line] = (dict_sus_Tarantula[source_line] * mutate_num + suspicious_now) / (mutate_num + 1)
                dict_sus_Tarantula_mutate_num_each_line[source_line] += 1
    ...
    dict_sus_Dstar3 = {}
    dict_sus_Dstar3_mutate_num_each_line = {}

    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_Dstar3.txt", 'r') as f:
    ...
    for sus_Dstar3_line in list_sus_Dstar3:
        ...
        for source_line in list_source_line:
            if dict_sus_Dstar3.get(source_line) == None:
                ...
                dict_sus_Dstar3_mutate_num_each_line[source_line] = 1
            else:
                mutate_num = dict_sus_Dstar3_mutate_num_each_line[source_line]
                dict_sus_Dstar3[source_line] = (dict_sus_Dstar3[source_line] * mutate_num + suspicious_now) / (mutate_num + 1)
                dict_sus_Dstar3_mutate_num_each_line[source_line] += 1

    Sus_Dstar3 = sorted(dict_sus_Dstar3.items(), key=operator.itemgetter(1), reverse=True)

    # output the result of mutants' suspicious.
    with open("./_MBFL_randomization_higher_order_mutant_set/suspicious_set_average.txt", 'w') as f:
        f.write("")
