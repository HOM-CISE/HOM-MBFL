...
def createResOriginalFaultVersionInShellFileMode():
    ...
    file_name = ""
    compile_dir = "./_MBFL_randomization_higher_order_mutant_set/compile/"
    ...
    f_create_shell.write("rm ./_MBFL_randomization_higher_order_mutant_set/res_original_version.in ./_MBFL_randomization_higher_order_mutant_set/res_fault_version.in\n")
    f_create_shell.write("touch ./_MBFL_randomization_higher_order_mutant_set/res_original_version.in ./_MBFL_randomization_higher_order_mutant_set/res_fault_version.in\n")
    ...
    for excute_mutation in mutation_list:
        ...
        for input_sample in input_list:
            ...
            f_create_shell.write('fi\n')
            f_create_shell.write('\n')
        f_create_shell.write("python3 MBFL_randomization_higher_order_MBFL/append_res_original_version_in.py --true_root_dir " + args.true_root_dir + "\n")
        f_create_shell.write("python3 MBFL_randomization_higher_order_MBFL/append_res_fault_version_in.py --defect_root_dir " + args.defect_root_dir + "\n")
...
def createResOriginalFaultVersionInShellArgsMode():
    f_create_shell = open("./create_res_original_fault_version_in.sh", "w")
    mutation_list = []
    with open("./_MBFL_randomization_higher_order_mutant_set/res_execute_mutant.txt", "r") as f:
        mutation_list = f.read()
        mutation_list = mutation_list.split("\n")[:-1]
    f.close()
