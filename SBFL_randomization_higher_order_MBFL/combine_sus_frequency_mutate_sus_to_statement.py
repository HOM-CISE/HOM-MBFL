...
if __name__ == "__main__":
    ...
    path_suspicious_set = "./_SBFL_randomization_higher_order_mutant_set/suspicious_set_frequency.txt"
    path_suspicious_combine = "./_SBFL_randomization_higher_order_mutant_set/suspicious_combine_frequency.txt"
