...
def CreateAllMutantSuspicious():
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/all_execute_mutant.txt", 'r') as f:
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/res_fault_version.in", "r") as f_fault:
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Jaccard.txt", 'w') as f:
        str_sus_Jaccard = "\n".join(list_sus_Jaccard)
        f.write(str_sus_Jaccard)
    f.close()
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Ochiai.txt", 'w') as f:
        str_sus_Ochiai = "\n".join(list_sus_Ochiai)
        f.write(str_sus_Ochiai)
    f.close()
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Op2.txt", 'w') as f:
        str_sus_Op2 = "\n".join(list_sus_Op2)
        f.write(str_sus_Op2)
    f.close()
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Tarantula.txt", 'w') as f:
        str_sus_Tarantula = "\n".join(list_sus_Tarantula)
        f.write(str_sus_Tarantula)
    f.close()
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Dstar3.txt", 'w') as f:
...
if __name__ == "__main__":
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Jaccard.txt", 'r') as f:
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Ochiai.txt", 'r') as f:
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Op2.txt", 'r') as f:
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Tarantula.txt", 'r') as f:
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_Dstar3.txt", 'r') as f:
    ...
    with open("./_SBFL_randomization_higher_order_mutant_set/suspicious_set_average.txt", 'w') as f:
        f.write("")
