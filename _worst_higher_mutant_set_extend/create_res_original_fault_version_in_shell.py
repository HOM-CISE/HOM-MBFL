...
def createResOriginalFaultVersionInShellFileMode():
    ...
    for mutant_set_index in range(1, args.num_mutants_set + 1):
        ...
        f_create_shell.write("rm ./_worst_mutant_set/res_original_version.in ./_worst_mutant_set/res_fault_version.in\n")
        f_create_shell.write("touch ./_worst_mutant_set/res_original_version.in ./_worst_mutant_set/res_fault_version.in\n")
        ...
        for excute_mutation in mutation_list:
            ...
            for input_sample in input_list:
                ...
                f_create_shell.write('fi\n')
                f_create_shell.write('\n')
            f_create_shell.write("python worst_higher_mutant_set_extend/append_worst_res_original_version_in.py --true_root_dir " + args.true_root_dir + "\n")
            f_create_shell.write("python worst_higher_mutant_set_extend/append_worst_res_fault_version_in.py --defect_root_dir " + args.defect_root_dir + "\n")
...
def createResOriginalFaultVersionInShellArgsMode():
    f_create_shell = open("./create_worst_res_original_fault_version_in.sh", "w")
    mutation_list = []
    with open("./_worst_mutant_set/res_execute_mutant.txt", "r") as f:
        mutation_list = f.read()
        mutation_list = mutation_list.split("\n")[:-1]
    f.close()
    ...
    file_name = ""
    compile_dir = "./_worst_mutant_set/compile/"
    con_list = os.walk(compile_dir)
    for path, path_l, file_names in con_list:
        file_name = file_names[0]
    ...
    for excute_mutation in mutation_list:
        ...
        for input_args, input_sample in zip(list_input_args, input_list):
            ...
            f_create_shell.write('fi\n')
            f_create_shell.write('\n')
        f_create_shell.write("python3 worst_higher_mutant_set_extend/append_worst_res_original_version_in.py --true_root_dir " + args.true_root_dir + "\n")
        f_create_shell.write("python3 worst_higher_mutant_set_extend/append_worst_res_fault_version_in.py --defect_root_dir " + args.defect_root_dir + "\n")
        f_create_shell.write("rm -rf ./temp_outputs/\n")
        f_create_shell.write("\n")
    f_create_shell.close()
