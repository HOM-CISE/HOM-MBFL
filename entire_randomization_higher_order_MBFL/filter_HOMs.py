...
if __name__ == "__main__":
    f_res_mutant_line_r = open("./_entire_randomization_higher_order_mutant_set/res_mutant_line.txt", 'r')
    f_res_execute_mutant_r = open("./_entire_randomization_higher_order_mutant_set/res_execute_mutant.txt", 'r')
    f_all_execute_mutant_r = open("./_entire_randomization_higher_order_mutant_set/all_execute_mutant.txt", 'r')
    f_res_record_r = open("./_entire_randomization_higher_order_mutant_set/res_record.txt", 'r')
    ...
    f_res_execute_mutant_w = open("./_entire_randomization_higher_order_mutant_set/res_execute_mutant.txt", 'w')
    f_all_execute_mutant_w = open("./_entire_randomization_higher_order_mutant_set/all_execute_mutant.txt", 'w')
