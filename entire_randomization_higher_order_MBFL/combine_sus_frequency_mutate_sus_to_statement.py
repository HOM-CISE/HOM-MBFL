...
def maxSus(first_order_item, set_item):
    if set_item[0] >= first_order_item:
        return set_item
    else:
        return [first_order_item, 1]
...
if __name__ == "__main__":
    ...
    path_suspicious_set = "./_entire_randomization_higher_order_mutant_set/suspicious_set_frequency.txt"
    path_suspicious_combine = "./_entire_randomization_higher_order_mutant_set/suspicious_combine_frequency.txt"
    ...
    for Jaccard_sus_set_line in list_Jaccard_sus_set:
        ...
        frequency_mutant_line = int(Jaccard_sus_set_line.split(', ')[2].split(']')[0])
        dict_sus_Jaccard_set[mutant_line] = [sus_mutant_line, frequency_mutant_line]
    ...
    for Ochiai_sus_set_line in list_Ochiai_sus_set:
        ...
        frequency_mutant_line = int(Ochiai_sus_set_line.split(', ')[2].split(']')[0])
        dict_sus_Ochiai_set[mutant_line] = [sus_mutant_line, frequency_mutant_line]
    ...
    for Op2_sus_set_line in list_Op2_sus_set:
        ...
        frequency_mutant_line = int(Op2_sus_set_line.split(', ')[2].split(']')[0])
        dict_sus_Op2_set[mutant_line] = [sus_mutant_line, frequency_mutant_line]
    ...
    for Tarantula_sus_set_line in list_Tarantula_sus_set:
        ...
        frequency_mutant_line = int(Tarantula_sus_set_line.split(', ')[2].split(']')[0])
        dict_sus_Tarantula_set[mutant_line] = [sus_mutant_line, frequency_mutant_line]
    ...
    for Dstar3_sus_set_line in list_Dstar3_sus_set:
        ...
        frequency_mutant_line = int(Dstar3_sus_set_line.split(', ')[2].split(']')[0])
        dict_sus_Dstar3_set[mutant_line] = [sus_mutant_line, frequency_mutant_line]
    ...
    for mutant_line in dict_sus_Jaccard_set.keys():
        dict_sus_Jaccard_combine[mutant_line] = maxSus(dict_sus_Jaccard_first_order[mutant_line], dict_sus_Jaccard_set[mutant_line])
    for mutant_line in dict_sus_Ochiai_set:
        dict_sus_Ochiai_combine[mutant_line] = maxSus(dict_sus_Ochiai_first_order[mutant_line], dict_sus_Ochiai_set[mutant_line])
    for mutant_line in dict_sus_Op2_set:
        dict_sus_Op2_combine[mutant_line] = maxSus(dict_sus_Op2_first_order[mutant_line], dict_sus_Op2_set[mutant_line])
    for mutant_line in dict_sus_Tarantula_set:
        dict_sus_Tarantula_combine[mutant_line] = maxSus(dict_sus_Tarantula_first_order[mutant_line], dict_sus_Tarantula_set[mutant_line])
    for mutant_line in dict_sus_Dstar3_set:
        dict_sus_Dstar3_combine[mutant_line] = maxSus(dict_sus_Dstar3_first_order[mutant_line], dict_sus_Dstar3_set[mutant_line])

    Sus_Jaccard = sorted(dict_sus_Jaccard_combine.items(), key=lambda kv:(kv[1], kv[0]), reverse=True)
    Sus_Ochiai = sorted(dict_sus_Ochiai_combine.items(), key=lambda kv:(kv[1], kv[0]), reverse=True)
    Sus_Op2 = sorted(dict_sus_Op2_combine.items(), key=lambda kv:(kv[1], kv[0]), reverse=True)
    Sus_Tarantula = sorted(dict_sus_Tarantula_combine.items(), key=lambda kv:(kv[1], kv[0]), reverse=True)
    Sus_Dstar3 = sorted(dict_sus_Dstar3_combine.items(), key=lambda kv:(kv[1], kv[0]), reverse=True)
