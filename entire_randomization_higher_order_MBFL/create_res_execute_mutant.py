...
if __name__ == "__main__":
    ...
    with open("./_entire_randomization_higher_order_mutant_set/res_execute_mutant.txt", 'w') as f:
        f.write("")   # create and clean res_record.txt
        f.close()
    f = open("./_entire_randomization_higher_order_mutant_set/res_execute_mutant.txt", 'a')
