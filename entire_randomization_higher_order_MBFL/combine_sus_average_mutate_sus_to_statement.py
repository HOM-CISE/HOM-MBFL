...
if __name__ == "__main__":
    ...
    path_suspicious_set = "./_entire_randomization_higher_order_mutant_set/suspicious_set_average.txt"
    path_suspicious_combine = "./_entire_randomization_higher_order_mutant_set/suspicious_combine_average.txt"
