...
def calcRank(list_fault_line, suspicious_file_root):
    suspicious_file_path = suspicious_file_root + "suspicious_first_order.txt"
...
def calcEXAMScore(list_fault_line, suspicious_file_root):
    ...
    f = open(suspicious_file_root + "suspicious_first_order_EXAM_score.txt", 'w')
...
if __name__ == "__main__":
    ...
    str_mutant_suspicious_file_root = "./output/"
